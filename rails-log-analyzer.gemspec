Gem::Specification.new do |s|
  s.name    = 'rails-log-analyzer'
  s.version = '0.1.0'
  s.date    = '2008-08-29'
  
  s.bindir = 'bin'
  s.executables = ['rails-log-analyzer', 'rails-log-database']
  s.default_executable = 'rails-log-analyzer'

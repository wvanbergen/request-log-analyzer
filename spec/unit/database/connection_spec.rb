...
describe RequestLogAnalyzer::Database do
  describe '.parse_database_connection_string' do
    ...
    it "should parse a name-value based string" do
      ...
      RequestLogAnalyzer::Database.parse_connection_string(string).should == {:adapter => 'sqlite3', :database => 'filename.db'}
    end
    ...
    it "should parse an URI-based string for MySQL" do
      ...
      RequestLogAnalyzer::Database.parse_connection_string(string).should == 
